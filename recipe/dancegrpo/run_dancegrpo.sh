...
TRAIN_FILE=${TRAIN_FILE:-"/gemini/space/wuxuaner/Dancegrpo/data/1__3B/rl_embeddings/processed_wan_prompt.json"}
TEST_FILE=${TEST_FILE:-"/gemini/space/wuxuaner/Dancegrpo/data/1__3B/rl_embeddings/processed_wan_prompt.json"}
...
HYDRA_FULL_ERROR=1 python3 -m recipe.dancegrpo.main_dancegrpo \
    ...
    reward_model.model.path='/nvfile-heatstorage/teleai-infra/wxe/Dancegrpo_verl/model/HPS_v2.1_compressed.pt' \
